...
const interactables = document.querySelectorAll('a, button, input, textarea, .project-card, .service-item, .skill-category, .highlight-card, .cert-card, .github-card, .repo-card, .testimonial-card');
